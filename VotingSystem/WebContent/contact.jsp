	...
	<div id="page">
		<div id="header">
			...
			<center>
				<div id="tagline">
					<div>
						<h2 style="height: 0px;">University of Mumbai</h2>
						<br> Vidya Nagari, Kala Ghoda, Fort, Mumbai, Maharashtra 400032<br>
						<br> Name: Meetali Mhatre<br> Email: <a
							href="mailto:meetali.mhatre@gmail.com">meetali.mhatre@gmail.com</a>
					</div>
				</div>
			</center>
		</div>
		...
		<div id="footer">
			<div>
				<div class="section">
					<p style="text-align: center;">Copyright &copy; Meetali Mhatre - All Rights Reserved.</p>
				</div>
			</div>
		</div>
	</div>
